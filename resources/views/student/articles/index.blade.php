        ...
        <div class="card-body p-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Baca artikel edukatif tentang kesehatan mental dan pencegahan kekerasan.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control border-0 bg-light" placeholder="Cari artikel berdasarkan judul atau konten..." value="{{ request('search') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex justify-content-between text-muted small mb-3">
                        ...
                        <span><i class="bi bi-calendar-fill me-1"></i> {{ $article->published_at->format('d M Y') }}</span>
                    </div>
                    
                    <a href="{{ route('student.articles.show', $article->id) }}" class="btn btn-warning text-white w-100">
