...
<div class="bg-white pt-12 pb-20">
    <div class="max-w-4xl mx-auto px-6">
        ...
        {{-- Article Content --}}
        <article class="prose prose-lg max-w-none prose-orange prose-img:rounded-xl prose-headings:text-gray-900 text-gray-700 leading-relaxed">
        ...
        <div class="mt-12 pt-8 border-t border-gray-100">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex gap-3">
                    <a href="#" class="w-10 h-10 rounded-full bg-green-100 text-green-600 flex items-center justify-center hover:bg-green-600 hover:text-white transition-all">
                        <i class="bi bi-whatsapp"></i>
                    </a>
                    <a href="#" class="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
                        <i class="bi bi-twitter-x"></i>
                    </a>
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center hover:bg-gray-600 hover:text-white transition-all">
        ...
        <div class="mt-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('public.article.show', $related->id) }}" class="group">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all h-full flex flex-col">
