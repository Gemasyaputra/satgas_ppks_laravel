                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="fw-medium text-dark text-truncate" style="max-width: 300px;">{{ $article->title }}</div>
                                        <div class="text-muted small text-truncate" style="max-width: 300px;">{{ $article->excerpt }}</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-muted small">{{ $article->published_at->format('d M Y') }}</td>
                            <td class="text-end">
