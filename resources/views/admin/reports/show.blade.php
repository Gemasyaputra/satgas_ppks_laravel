            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white border-bottom-0 pt-4 px-4">
                    <ul class="nav nav-tabs card-header-tabs" id="reportTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold" id="chat-tab" data-bs-toggle="tab" data-bs-target="#chat" type="button" role="tab">
                            ...
                            <div class="d-flex justify-content-between align-items-start mb-4">
                                <div>
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <span class="badge bg-light text-dark border fw-normal">
                                            <i class="bi bi-calendar-event me-1"></i> {{ $report->created_at->format('d M Y') }}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="card bg-light border-0 h-100">
                                        <div class="card-body">
                                            <h6 class="fw-bold text-primary mb-3"><i class="bi bi-geo-alt-fill me-2"></i>Detail Kejadian</h6>
                                            <div class="mb-2">
                                                <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Jenis Kekerasan</small>
                                                <span class="fw-medium">{{ $report->violence_type }}</span>
                                            </div>
                                            <div class="mb-2">
                                                <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Tanggal Kejadian</small>
                                                <span class="fw-medium">{{ \Carbon\Carbon::parse($report->report_date)->format('d F Y') }}</span>
                                            </div>
                                            <div class="mb-2">
                                                <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Lokasi</small>
                                                <span class="fw-medium">{{ $report->incident_location }}</span>
                                            </div>
                                            <div>
                                                <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Status Disabilitas</small>
                                ...
                                <div class="col-md-6">
                                    <div class="card bg-light border-0 h-100">
                                        <div class="card-body">
                                            <h6 class="fw-bold text-danger mb-3"><i class="bi bi-person-exclamation me-2"></i>Info Terlapor</h6>
                                            <div class="mb-2">
                                                <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Nama Terlapor</small>
                                                <span class="fw-medium">{{ $report->reported_party_name }}</span>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Status/Pekerjaan</small>
                                                    <span class="fw-medium">{{ $report->reported_party_occupation }}</span>
                                                </div>
                                                <div class="col-6">
                                                    <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Usia</small>
                                                    <span class="fw-medium">{{ $report->reported_party_age }} Tahun</span>
                                                </div>
                                            </div>
                                            <hr class="border-secondary opacity-25 my-2">
                                            <div>
                                                <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Saksi</small>
                                ...
                                {{-- 3. Kronologi & Alasan --}}
                                <div class="col-12">
                                    <h6 class="text-muted small text-uppercase fw-bold border-bottom pb-2 mb-3">Kronologi Lengkap</h6>
                                    <div class="p-3 bg-light rounded border-start border-4 border-warning">
                                        <p class="text-dark mb-0" style="white-space: pre-wrap; line-height: 1.6;">{{ $report->description }}</p>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <h6 class="text-muted small text-uppercase fw-bold border-bottom pb-2 mb-2">Alasan Melapor</h6>
                                    <p class="mb-0">{{ $report->reason_for_reporting }}</p>
                                </div>
                                <div class="col-md-6">
                                    <h6 class="text-muted small text-uppercase fw-bold border-bottom pb-2 mb-2">Kebutuhan Korban</h6>
        ...
        <div class="col-lg-4">
                    ...
                    @else
                        <div class="text-center mb-4">
                            <img src="{{ $report->user->photo_url ?? 'https://via.placeholder.com/80' }}" 
                                 class="rounded-circle mb-2 border p-1" style="width: 80px; height: 80px; object-fit: cover;">
                        ...
                        <ul class="list-group list-group-flush small">
                            ...
                            <li class="list-group-item px-0">
                                ...
                                <span class="fw-medium text-dark">{{ $report->reporter_pob }}, {{ \Carbon\Carbon::parse($report->reporter_dob)->format('d M Y') }}</span>
                            </li>
                            <li class="list-group-item px-0">
            ...
            <div class="card shadow-sm border-0 bg-warning-subtle">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary w-100 fw-bold" data-bs-toggle="modal" data-bs-target="#updateReportModal{{ $report->id }}">
