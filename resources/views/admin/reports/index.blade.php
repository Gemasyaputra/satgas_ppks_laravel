                        ...
                        @forelse ($reports as $report)
                            <tr>
                                ...
                                <td class="ps-4 py-3">
                                    ...
                                    @else
                                        <div class="d-flex align-items-center">
                                            <div class="rounded-circle bg-primary-subtle text-primary d-flex align-items-center justify-content-center me-3 fw-bold border border-primary-subtle" style="width: 40px; height: 40px;">
                                                {{ substr($report->user->name, 0, 1) }}
                                            </div>
                                            <div>
                                                <div class="fw-bold text-dark">{{ Str::limit($report->user->name, 15) }}</div>
                                ...
                                {{-- Kolom Judul --}}
                                <td>
                                    <div class="fw-bold text-dark text-truncate" style="max-width: 200px;" title="{{ $report->title }}">
                                        {{ $report->title }}
                                    </div>
                                ...
                                <td class="text-end pe-4">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.reports.show', $report->id) }}" class="btn btn-sm btn-light text-primary border-0" title="Lihat Detail">
